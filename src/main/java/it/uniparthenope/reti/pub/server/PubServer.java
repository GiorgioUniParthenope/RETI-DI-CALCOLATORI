    ...
    private static final class PubDashboard {
        ...
        private String dashboardHtml() {
            return "<!doctype html>"
                    ...
                    + ".top{background:#283b32;color:#fff;padding:22px 26px;display:flex;justify-content:space-between;align-items:center;gap:16px}.top h1{margin:0;font-size:27px}.top p{margin:6px 0 0;color:#e6ece5}.clock{border:1px solid rgba(255,255,255,.35);border-radius:6px;padding:9px 12px;color:#ffdfad;font-weight:700;white-space:nowrap}"
                    + ".wrap{max-width:1180px;margin:0 auto;padding:22px}.summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-bottom:18px}.metric{background:#fff;border:1px solid var(--line);border-radius:8px;padding:14px}.metric span{display:block;color:var(--muted);font-size:12px;font-weight:700;text-transform:uppercase}.metric strong{font-size:25px;margin-top:4px;display:block}"
                    + ".grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px}.receipt{background:var(--paper);border:1px solid var(--line);border-radius:8px;box-shadow:0 2px 0 rgba(0,0,0,.05);padding:16px;min-height:230px}.receipt.active{border-color:#8da892}.receipt h2{margin:0;font-size:20px}.receipt .head{display:flex;justify-content:space-between;gap:10px;align-items:flex-start;border-bottom:1px dashed #bbb3a2;padding-bottom:10px;margin-bottom:10px}.status{font-size:12px;font-weight:700;border-radius:20px;padding:6px 9px;background:#ece9dd;color:#4a4d46;white-space:nowrap}.active .status{background:#e3efe6;color:#23523f}.line{display:grid;grid-template-columns:54px 1fr;gap:10px;padding:8px 0;border-bottom:1px dashed #ddd5c5}.line:last-child{border-bottom:0}.time{color:var(--muted);font-size:12px}.line strong{display:block;font-size:13px}.line span{display:block;font-size:14px;margin-top:2px}.empty{color:var(--muted);padding:20px 0}.customer{color:var(--muted);font-size:13px;margin-top:4px}"
                    + "@media(max-width:760px){.top{align-items:flex-start;flex-direction:column}.wrap{padding:14px}.summary{grid-template-columns:1fr}.grid{grid-template-columns:1fr}}"
                    + "</style>"
                    + "</head>"
                    + "<body>"
