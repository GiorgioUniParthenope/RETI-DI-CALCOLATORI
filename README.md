...
La webapp clienti permette di far entrare piu' clienti: ogni cliente riceve un tavolo diverso, richiede il menu ed effettua l'ordine. La dashboard cameriere consente di scegliere un tavolo attivo da una select e di passare al tavolo precedente o successivo con le frecce laterali, senza duplicare il flusso degli ordini. La dashboard pub permette di evadere manualmente gli ordini in preparazione.
